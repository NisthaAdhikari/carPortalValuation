            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form method="POST" action="{{ route('car.update', $cars->id) }}" enctype="multipart-data" class="form-horizontal form-label-left">
                      {{ csrf_field() }}
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="brand" required="required" name="brand" class="form-control" value="{{isset($cars->brand)? $cars->brand : ''}}">
                            @if ($errors->has('brand'))
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="model" required="required" name="model" class="form-control" value="{{isset($cars->model)? $cars->model : ''}}">
                            @if ($errors->has('model'))
                              <span class="help-block" style="color: red;">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="version" name="version" class="form-control" value="{{isset($cars->version)? $cars->version : ''}}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="number" step="0.01" id="current_mp" name="current_mp" required="required" class="form-control" value="{{isset($cars->current_mp)? $cars->current_mp : ''}}">
                          @if ($errors->has('price'))
                              <span class="help-block" style="color: red;">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <textarea id="features" type="text" class="form-control" rows="6" cols="50"
                                        name="features" value="{{ old('features') }}" required > {{isset($cars->features)? $cars->features : ''}}</textarea>
                        </div>
                      </div>
